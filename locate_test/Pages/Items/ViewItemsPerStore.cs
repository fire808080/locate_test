...
namespace ssms.Pages.Items
{
    public partial class ViewItemsPerStore : UserControl
    {
        ...
        private void saveFileDialog1_FileOk(object sender, CancelEventArgs e)
        {
            ...
            Paragraph writing = new iTextSharp.text.Paragraph("Rfid Reader Management System " + Environment.NewLine + "View Items per Store Information: " + what + "                " + DateTime.Now.ToString() + Environment.NewLine+ "Store Selected: " + store + "                " + Environment.NewLine + Environment.NewLine);
